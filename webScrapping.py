...
def googleSearch(query):
	...
	query = query.replace('show me the results for','')
...
def email(rec_email=None, text="Hello, It's A.A.R.Y.A. here...", sub='A.A.R.Y.A.'):
	if '@gmail.com' not in rec_email: return
	s = smtplib.SMTP('smtp.gmail.com', 587)
	s.starttls()
	s.login("aaryaassisstant@gmail.com", "Assisstant@45")
	message = 'Subject: {}\n\n{}'.format(sub, text)
	s.sendmail("aaryaassisstant@gmail.com", rec_email, message)
	print("Sent")
	s.quit()
